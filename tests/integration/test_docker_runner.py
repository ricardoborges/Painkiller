...
async def test_docker_runner_clarification_exit_42():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        mock_container.logs.return_value = b"Starting aider...\nExiting for clarification (exit 42)\n"
...
async def test_docker_runner_success_exit_0():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        mock_container.logs.return_value = b"Aider completed successfully.\n"
        ...
        assert "Aider completed successfully" in result.logs
